...
hi Constant        ctermbg=NONE ctermfg=136    guibg=NONE     guifg=#C5735E  cterm=NONE      gui=NONE
hi Function        ctermbg=NONE ctermfg=117    guibg=NONE     guifg=#CC6666  cterm=NONE      gui=NONE
hi Identifier      ctermbg=NONE ctermfg=179    guibg=NONE     guifg=#E5C078  cterm=NONE      gui=NONE
hi PreProc         ctermbg=NONE ctermfg=159    guibg=NONE     guifg=#85A7A5  cterm=NONE      gui=NONE
...
hi Statement       ctermbg=NONE ctermfg=130    guibg=NONE     guifg=#A57A9E  cterm=NONE      gui=NONE
hi String          ctermbg=NONE ctermfg=110    guibg=NONE     guifg=#95B47B  cterm=NONE      gui=NONE
...
hi Error           ctermbg=9    ctermfg=12     guibg=NONE     guifg=#AF5F5F  cterm=underline gui=reverse
...
hi CursorLineNr    ctermbg=0    ctermfg=250    guibg=NONE     guifg=#808080  cterm=NONE      gui=NONE

hi Pmenu           ctermbg=233  ctermfg=137    guibg=#171717  guifg=#E8A973  cterm=none      gui=NONE
hi PmenuSel        ctermbg=234  ctermfg=179    guibg=#252525  guifg=#FF2A1F  cterm=bold      gui=bold
...
hi Visual          ctermbg=25   ctermfg=252    guibg=#111314  guifg=#6E9CAF  cterm=NONE      gui=NONE
